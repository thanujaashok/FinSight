...
// Fetch data function
function fetchData(company, timeframe, emaPeriod, rsiPeriod) {
    fetch(`/api/data/${company}/${timeframe}/${emaPeriod}/${rsiPeriod}`)
...
document.getElementById('fetchData').addEventListener('click', () => {
    ...
    fetchData(company, timeframe, emaPeriod, rsiPeriod);
});
        ...
        .then(symbols => {
            ...
            symbols.forEach(symbol => {
                ...
                item.addEventListener('click', () => {
                    document.getElementById('company').value = symbol;
